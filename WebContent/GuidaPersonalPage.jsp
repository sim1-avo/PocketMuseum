...
<%@page import="control.opera.*"%>
<%@page import="control.homepage.*"%>
...
<div id="content">
    ...
    <button
      ...
      type="button" class=" mybutton btn btn-secondary d-block" id="eventoButton" style="width:80%;margin-left:10%">Gestione
      Evento</button>
    </div>
    -->
	</div>	
